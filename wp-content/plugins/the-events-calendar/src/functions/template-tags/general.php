...
if ( class_exists( 'Tribe__Events__Main' ) ) {
	 ...
	 * @return mixed
	 */
	function tribe_get_date_format( $year ) {
		$format = tribe_get_option( 'dateWithoutYearFormat', 'M j' );
		$year=tribe_get_option( 'dateWithoutYearFormat', 'Y' );
	...
	function tribe_events_event_schedule_details( $event = null, $before = '', $after = '' ) {
		...
		$date_with_year_format    = tribe_get_date_format(false );
