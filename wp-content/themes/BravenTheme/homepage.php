...
get_header(); ?>
    ...
    <?php echo do_shortcode('[rev_slider sliderhome]')?>
    </div>
...
<div class="client-contact-info"><h5 style="margin:0;"><?php echo $data[ 'person-name' ]; ?></h5><?php echo $data[ 'position' ]; ?>&nbsp;<a href="<?php echo $data[ 'link' ]; ?>" title="<?php echo $data[ 'company' ]; ?>"><?php echo $data[ 'company' ]; ?></a></div>
</div>
<div class="clear"></div>
</div>
</div>
...
<a href="<?php echo $pfdata[ 'plink' ]; ?>" target="_blank"><?php echo the_post_thumbnail();?></a>
</div>
<?php wp_reset_query();?>
<?php endwhile;?>
<?php endif; ?>
